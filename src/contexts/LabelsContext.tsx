...
const DEFAULT_LABELS: Record<string, string> = {
  ...
  field_mrr: "MRR",
  field_gmv: "GMV",
  field_merchant_size: "Merchant Size",
  field_city: "City",
  field_sub_platform: "Sub Platform",
  field_tracker_month: "Tracker Month",
  field_current_phase: "Current Phase",
  field_project_state: "Project State",
  field_current_responsibility: "Waiting On",
